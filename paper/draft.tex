...
%% Compile: pdflatex draft.tex (twice for refs)
%% Place all fig*.png in the same folder as this file.
...
Hall effect, and anomalous thermoelectric signals. In clean samples where $\tau_{ee}<\tau_{\mathrm{mr}}$, 
hydrodynamic collective flow dominates. Three times coexist: $\tau_{ee}$ (inelastic), 
$\tau_{\mathrm{mr}}$ (momentum-relaxing), and $\tau_5$ (intervalley). Recent experiments 
on WP$_2$ and NbP show width-dependent resistivity and putative anomaly signatures, 
...
\end{align}
with bulk values from Lucas--Davison--Sachdev and Messica--Ostrovsky--Gutman.

\section{Benchmarks}

All 9 benchmarks pass (Fig.~\ref{fig:9}): (a) classical Gurzhi $\sigma_{\mathrm{hydro}}(W) = g(W/2\ell_G)$, 
(b) anomalous Gurzhi $\sigma_{\mathrm{anom}}(W) = g(W/2\ell_5)$, (c) negative MR $\sigma \propto B^2$.
...
cancellation at finite $\sigma_Q$ or $B$.
...
\begin{figure}[!tb]
\centering
\includegraphics[width=0.95\columnwidth]{fig1_gurzhi_factor.png}
...
\begin{figure}[!tb]
\centering
\includegraphics[width=0.95\columnwidth]{fig2_two_gurzhi_scales.png}
...
\begin{figure*}[!tb]
\centering
\includegraphics[width=0.95\textwidth]{fig3_thermoelectric_gurzhi.png}
...
\begin{figure}[!tb]
\centering
\includegraphics[width=0.95\columnwidth]{fig4_L_map.png}
...
\begin{figure*}[!tb]
\centering
\includegraphics[width=0.95\textwidth]{fig5_anomaly_contribution.png}
...
\begin{figure}[!tb]
\centering
\includegraphics[width=0.95\columnwidth]{fig6_poiseuille.png}
...
\begin{figure}[!tb]
\centering
\includegraphics[width=0.95\columnwidth]{fig7_T_dependence.png}
...
\begin{figure}[!tb]
\centering
\includegraphics[width=0.95\columnwidth]{fig8_regimes.png}
...
\begin{figure*}[!tb]
\centering
\includegraphics[width=0.95\textwidth]{fig9_benchmarks.png}
...
\bibitem{Lucas2016} A. Lucas, R. A. Davison, S. Sachdev, PNAS \textbf{113}, 9463 (2016).
\bibitem{Gooth2017} J. Gooth \textit{et al.}, Nature \textbf{547}, 324 (2017).
\bibitem{Gooth2018} J. Gooth \textit{et al.}, Nat. Commun. \textbf{9}, 4093 (2018).
\bibitem{Messica2023} Y. Messica, P. Ostrovsky, D. Gutman, PRB \textbf{107}, 235102 (2023).
\bibitem{Sukhachov2022} P. Sukhachov, B. Trauzettel, PRB \textbf{105}, 085141 (2022).
\bibitem{Levitov2016} L. Levitov, G. Falkovich, Nat. Phys. \textbf{12}, 672 (2016).
\bibitem{Bandurin2016} D. Bandurin \textit{et al.}, Science \textbf{351}, 1055 (2016).
\bibitem{Crossno2016} J. Crossno \textit{et al.}, Science \textbf{351}, 1058 (2016).
\end{thebibliography}
